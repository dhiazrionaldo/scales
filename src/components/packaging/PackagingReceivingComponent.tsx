...
export function PackagingReceivingComponent({
  warehouseId,
  companyId,
  onSuccess,
  ...
  const submitImage = async (file: File) => {
    try {
      ...
      const response = await fetch('/api/packaging/receiving', {
        method: 'POST',
        body: formData,
      });
  ...
  const submitJson = async (parsed: {
    ...
    try {
      ...
      const response = await fetch('/api/packaging/qr-receiving', {
        method: 'POST',
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/packaging/confirm-location', {
        method: 'PUT',
        headers: {
