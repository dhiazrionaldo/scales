...
export function ReceivingComponent({
  ...
  const submitImage = async (file: File) => {
    try {
      ...
      const response = await fetch('/api/finish-good/receiving', {
        method: 'POST',
        body: formData,
      });
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/finish-good/confirm-location', {
        method: 'PUT',
      ...
      if (task) {
        ...
        const putawayResponse = await fetch('/api/finish-good/complete-putaway', {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
  ...
  //       // const responses = await fetch('/api/finish-good/complete-putaway', {
  //       //   method: 'PUT',
  //       //   headers: { 'Content-Type': 'application/json' },
  //       //   body: JSON.stringify({
