...
import { PutawayModuleComponent } from '@/components/finish-good/PutawayModuleComponent';
  ...
  if (loadingCompanies) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Putaway Tasks</h1>
  ...
  return (
    <div className="space-y-6">
      <div className="px-6 pt-6 flex gap-4">
        ...
        <h1 className="text-3xl font-bold text-gray-200">Putaway Tasks</h1>
      </div>
      <div>
