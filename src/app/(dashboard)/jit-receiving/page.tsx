...
import { JITReceivingComponent } from '@/components/jit/PackagingReceivingComponent';
import React from 'react';
import { useSettingsContext } from "@/app/(dashboard)/settings/settings-context";

export default function JITReceivingPage() {
